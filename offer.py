...
class Offer:
    ...
    def get_insert_offer_query(self):
        return "INSERT INTO offers VALUES " + "('" + self._title + "', '" + self._url + "', '" + self._url_image + "', '" \
               + self._date.strftime("%m/%d/%Y, %H:%M:%S") + \
               "', '" + str(self._new_price) + "', '" + str(self._old_price) + "', '" + self._color + "')"
    ...
    def print_offer(self):
        print(self._title + ' ' + self._color + ' ' + self._url + ' ' + str(self._date) + ' old price: ' + \
